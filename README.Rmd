...
The package is now feature-complete and being readied for its first CRAN
release. It has a suite of tests and documentation. It is still possible that 
you will find bugs that our own test data has not thrown up, so please provide 
any feedback and or issues you have with the code.
...
summary of the contents and lists th the avaible tags.
...
Likewise, we can produce a ggplot histogram of the distributoin of alignment 
lengths in the file.
...
If we decide we don't llike those shorter alignments, we can remove them with
`subset` or 
