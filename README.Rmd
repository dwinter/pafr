...
![Devlopment stage](https://img.shields.io/badge/development--stage-beta-orange)
...
usable package. The package is now feature-complete, and all functions are
documented. However, there may still be bugs in the code that haven't been
exposed by our tests and it is possible we will introduce breaking-changes
in the future.

Nevertheless, we'd appreciate feedback from anyone that might the package.
