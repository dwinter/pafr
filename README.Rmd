...
summary of the contents and lists the the avaible tags.
...
In this example we visualize the sequences in the traget genome, shading each
aligned-regoin according to query-sequence aligning to that region.
