...
In this case, there is a total of 35 Mb of aligned genome sequence, representing 8 query
and 8 target sequences. `read_paf` lists the 12 columns of the file PAF format with
column names labeled as in the table above.

In addition, any tags present in the `.paf` file will be included as an additional column. The tags
...
divergent. But there are also some very long alignments, which all show high
similarity. 
...
mitochrondial genome diplays less diveregnce than any of the autosomal chromosomes in this 
particular species.
